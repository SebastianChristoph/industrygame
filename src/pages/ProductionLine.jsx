        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, flex: 1 }}>
          ...
          {selectedRecipe && (
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, ml: 2 }}>
              <Typography variant="h6" sx={{ color: '#ff4444', fontWeight: 700 }}>
                -{inputCost}$
              </Typography>
              {isSelling && (
                <>
                  <Typography variant="h6" sx={{ color: '#4caf50', fontWeight: 700 }}>+{sellIncome}$</Typography>
                </>
              )}
              <Typography variant="h6" sx={{ color: balance >= 0 ? '#4caf50' : '#ff4444', fontWeight: 700 }}>
                = {balance >= 0 ? '+' : ''}{balance}$
              </Typography>
            </Box>
          )}
          ...
          <Box sx={{ 
            ...
            {(productionStatus?.isActive || productionStatus?.currentPings >= selectedRecipe?.productionTime) && (
              <Box sx={{ position: 'relative', width: '100%' }}>
                ...
                >
                  <Typography variant="body2" sx={{ fontWeight: 600, color: 'text.primary', textShadow: '0 1px 2px #fff8' }}>
